<template>
    <div
        class="w-full lg:w-7/12 mx-auto px-4 bg-white pb-8 min-h-[200vh] pt-0 lg:pt-8"
    >
        <div class="flex justify-between py-4 px-0 lg:px-4 mb-4">
            ...
            <p class="text-black text-base">Lucky Numbers</p>
                ...
                <div class="overflow-x-auto">
                    <div class="inline-block min-w-full">
                        <div class="overflow-hidden">
                            ...
                            >
                                <thead
                                    class="border-b border-neutral-200 font-medium bg-[#F69312] text-white"
                                >
                                    <tr>
                                        <th
                                            scope="col"
                                            class="px-3 py-4 border-none w-16"
                                        >
                                            Number
                                        </th>
                                        <th
                                            scope="col"
                                            class="px-3 py-4 border-none"
                                        >
                                            count
                                        </th>
                                        <th
                                            scope="col"
                                            class="px-3 py-4 border-none text-right"
                                        >
                                            Update
                                        </th>
                                    </tr>
                                ...
                                >
                                    <tbody v-if="numberList.length > 0">
                                        ...
                                        >
                                            <td
                                                class="whitespace-nowrap px-3 md:px-6 py-4 font-medium w-16"
                                            >
                                                {{ num.twoD }}
                                            </td>
                                            <td class="px-3 py-4">
    ...
    methods: {
        async getNumberList() {
            ...
            const response = await getApiData({
                url: "http://128.199.218.198:83/api/2d/lucky_numbers",
            });
            if (response.data) {
                setTimeout(() => {
