<template>
    <div class="w-full lg:w-7/12 mx-auto px-4 bg-white pb-20">
        <div class="flex justify-between py-4 mb-4">
            ...
            <p class="text-black text-base">3D Live</p>
        ...
        <div class="w-full mx-0 lg:w-7/12 lg:mx-auto mb-12">
            <div
                ...
                :key="index"
                class="rounded-lg py-4 px-4 lg:px-8 threed-bg text-white mb-4"
            >
                <div class="contents">
                    <div class="flex justify-between mb-3">
                        <p>Date</p>
                        <p class="text-black">3D</p>
                    </div>
    ...
    methods: {
        async getInitial3DList() {
            const response = await getApiData({
                url: "http://128.199.218.198:83/api/3d/results/yearly",
            });
            if (response.data) {
