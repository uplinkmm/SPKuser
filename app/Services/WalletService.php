...
class WalletService
{
    ...
    public static function buildDepositMeta(Customer $customer, Customer $target_user, TransactionName $transaction_name, array $meta = [])
    {
        return array_merge([
            'name' => $transaction_name->value,
            'opening_balance' => $customer->balanceFloat,
            'target_user_id' => $target_user->id,
        ], $meta);
    }
